...
-(instancetype)PustInstance{
    static BlueTooth* manager = nil;
...
- (void)centralManagerDidUpdateState:(CBCentralManager *)central {
    ...
    if(self.MCmanagerState){
        self.MCmanagerState(central,nil);
    }
}
/** 发现符合要求的外设，回调 */
...
- (void)centralManager:(CBCentralManager *)central didDisconnectPeripheral:(CBPeripheral *)peripheral error:(nullable NSError *)error {
    ...
    if (self.MCmanagerError) {
        self.MCmanagerError(central,nil);
    }else{
        // 断开连接可以设置重新连接
        [central connectPeripheral:peripheral options:nil];
    }
...
- (void)peripheralManagerDidUpdateState:(CBPeripheralManager *)peripheral {
    ...
    if (self.MCmanagerState) {
        self.MCmanagerState(nil,peripheral);
    }
}
/** 创建服务和特征 */
...
- (void)peripheralManagerDidStartAdvertising:(CBPeripheralManager *)peripheral error:(nullable NSError *)error{
    if (self.MCmanagerError) {
        self.MCmanagerError(nil, peripheral);
    }
}
/** 订阅成功回调 */
